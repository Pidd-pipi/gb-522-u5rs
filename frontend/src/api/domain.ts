...
export const eventApi = {
  ...
  review: (id: number, body: { event_type: EventType; distance_m?: number; review_note: string; version: number }) => api.patch<ApiEnvelope<EventMarker>>(`/events/${id}/review`, body),
  revisions: (id: number) => api.get<ApiEnvelope<EventRevision[]>>(`/events/${id}/revisions`),
}
